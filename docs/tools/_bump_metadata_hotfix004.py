#!/usr/bin/env python3
"""Prepend HOTFIX-004 last_changes bullet and bump metadata version."""
...
BULLET = "- HOTFIX-004: stationary MG stays controllable after save/load (no remount) [no new game]\\n"
...
def main() -> int:
    ...
    print("last_changes head:", field[:120])
    return 0
