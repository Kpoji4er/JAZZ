...
vanilla = (game / "ModTools/Src/Lua/Tactical/Emplacement.lua").read_text(encoding="utf-8")
...
function PlaceInventoryItem(id)
  ...
  return {class=id, MagazineSize=100,
...
for distance, expected in [(91200, 91200), (1, 114000), (999999, 114000)]:
...
print("PASS authored distance, min/max clamp, repeated Update, ammo remap")
...
assert(unit.target==91200 and unit.count==1 and base_calls==0)
""")
