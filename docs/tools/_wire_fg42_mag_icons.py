"""Insert MagNormal Visual ApplyTo=FG42 → Magazine/FG42_Mag20.png.

FG42 has no Magazine slot (mag in mesh); Visual for base-mag Icon catalog.
"""
...
ICON = "Mod/e6L4ECj/WeaponComponents/Magazine/FG42_Mag20.png"
...
def main() -> None:
    ...
    if 'ApplyTo = "FG42"' in body and "FG42_Mag20" in body:
        print("already")
    else:
        for key in (
            'ApplyTo = "FAMAS"',
