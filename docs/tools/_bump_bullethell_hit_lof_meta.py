# Bump jazz/metadata.lua: revision +1, prepend BulletHell hit-LoF hotfix last_changes.
...
BULLET = (
    "- COMBAT-006: Spike BulletHell hits the cone unit; miss fan at chest height (not dirt) [no new game]"
)
