# -*- coding: utf-8 -*-
"""Bump jazz Revision + prepend BulletHell honest-CTH / cone Will dump bullet."""
...
BULLET = (
    "- COMBAT-006: Spike BulletHell honest CTH + Will dump on everyone in the cone "
    "[no new game]"
)
...
def main() -> None:
    ...
    print("last_changes starts:", chunk[:140])
