"""Insert MagNormal Visual ApplyTo=M3GreaseGun → Magazine/M3_Mag30.png.

M3 has no Magazine slot (mag in mesh); Visual for future base-mag icons.
"""
...
def main() -> None:
    ...
    if 'ApplyTo = "M3GreaseGun"' in body and "M3_Mag30" in body:
        print("already")
    else:
        needle = (
            "\t\t\t\t\t\t\tPlaceObj('WeaponComponentVisual', {\n"
