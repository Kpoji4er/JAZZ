"""Wire JAZZ_Handgrip_Default ApplyTo=P210 Icon."""
...
ICON = "Mod/e6L4ECj/WeaponComponents/Handgrip/P210_Handgrip_Default.png"
MARKER = 'id = "JAZZ_Handgrip_Default"'
OLD = (
    'ApplyTo = "P210",\n'
    '\t\t\t\t\t\t\t\tEntity = "P210HandGrip",\n'
    '\t\t\t\t\t\t\t\tSlot = "Handgrip",'
...
def main() -> None:
    ...
    if ICON in body and "P210HandGrip" in body:
        print("already")
        return
    if OLD not in body:
        i = body.find("P210HandGrip")
