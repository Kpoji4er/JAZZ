"""Insert MagNormal Visual ApplyTo=Sterling → Magazine/Sterling_Mag34.png.

Sterling has no Magazine slot (side mag in mesh); Visual for future base-mag icons.
"""
...
def main() -> None:
    ...
    if 'ApplyTo = "Sterling"' in body and "Sterling_Mag34" in body:
        print("already")
    else:
        needle = (
            "\t\t\t\t\t\t\tPlaceObj('WeaponComponentVisual', {\n"
