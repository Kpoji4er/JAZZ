"""Insert MagNormal Visual ApplyTo=STG44 → Magazine/STG44_Mag30.png.

STG44 has no Magazine slot (mag in mesh); Visual for base-mag Icon catalog.
"""
...
ICON = "Mod/e6L4ECj/WeaponComponents/Magazine/STG44_Mag30.png"
...
def main() -> None:
    ...
    if 'ApplyTo = "STG44"' in body and "STG44_Mag30" in body:
        print("already")
    else:
        for key in (
            'ApplyTo = "Sterling"',
