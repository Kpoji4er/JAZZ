...
ENTRIES = [
    ...
    (890000000009239, "Pain when exerting. No Tiredness from ribs. No direct AP penalty.", "Боль при нагрузке. Без Tired от рёбер. Без прямого −ОД."),
    (890000000009240, "Rib Trauma (Medium)", "Травма рёбер (средняя)"),
    (890000000009241, "Start-of-turn AP <color EmStyle>-<APLoss></color>. No Free Move. Pain on exertion. No Tiredness.", "ОД на старте хода <color EmStyle>-<APLoss></color>. Нет Free Move. Боль при нагрузке. Без Tired."),
