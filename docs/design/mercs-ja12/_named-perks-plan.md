...
| Support/Trade | Flo, Vicious (flavor AP) | economy **или** squad AP fantasy | combat crit machine; разгрузка/inventory |
...
Biff / Rothman / Ira / Miguel / Flo / Gamos / Conrad / Hobbit / Highball — только в Simplify-форме из §5.3 или полным operation-spec. **Разгрузки/inventory — вне скоупа именных перков.**
