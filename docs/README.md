...
- [`design/`](design/) — авторские заметки и how-to по движку/контенту (не current-state runtime). Гайд по своим building slab: [RU](design/ja3-how-to-custom-slabs.md) / [EN](design/ja3-how-to-custom-slabs.en.md). Sample-мод: [Kpoji4er/JAZZ-slabs-sample](https://github.com/Kpoji4er/JAZZ-slabs-sample). Черновик Global AI армии/Адонис (ветки, фронт, шахты, транспорт): [army-presence-and-travel.md](design/army-presence-and-travel.md).
