...
- [`design/`](design/) — авторские заметки и how-to по движку/контенту (не current-state runtime). Гайд по своим building slab: [ja3-how-to-custom-slabs.md](design/ja3-how-to-custom-slabs.md).
