...
4. **`AIEnumValidDests` OptLoc dest-cap (JAZZ-AI-PERF-001 follow-up)** — after CollapsePoints, cap `all_destinations` to **200** (stay/important/behavior, then nearest **threat**). Prevents TakeCover over 2k–3k open-slab dests on M1.
