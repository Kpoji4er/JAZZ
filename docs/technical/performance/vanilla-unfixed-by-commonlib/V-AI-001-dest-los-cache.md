...
- **Dest-cap:** at most `JAZZ_AI_PERF_DESTLOS_CAP` (**200**, was 320) CheckLOS dests — prefer stay / `important_dests` / `destinations`, then nearest to unit; remainder stay `false`.
