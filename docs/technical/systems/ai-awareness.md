...
Hidden sight balance (`JAZZ-AI-005`): укрытие Hidden ×35%, ночной floor modifier 12, Stealthy −25 — непрерывная формула без kit-порогов. Подробности — [видимость](visibility-weather-appearance.md).
