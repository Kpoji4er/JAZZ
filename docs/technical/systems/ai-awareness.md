...
- `Code/CombatAI.lua` — crowd/casualty POL-004; SNIPER-001 hold + **optic-aware range**; dynamic semi-sniper (aura-assigned) uses same hold/optics path; ACT-003 MG half-cover; **mortar outdoor bias** (`jazz_need_outdoors`: Indoors −400 / Outdoors +120; rear-guard ignores indoor allies as front);
