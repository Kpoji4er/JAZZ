...
| `System_EmplacementAmmo.lua` | loaded | [Оружие](weapons-ammo-components.md) — remap cut `_50BMG_*` emplacement ammo → `JAZZ_AMMO_50BMG_*`; HOTFIX-004 load reseat `ManningEmplacement`; `Jazz_EmplacementConeDist` keeps map/`WeaponRange` cone |
