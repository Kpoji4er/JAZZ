...
- **Угол mishap:** при `Explosives < 20` — полный круг; иначе сектор вокруг линии броска, ширина `360°` на 20 и `30°` на 100 (`GetMishapDeviationSectorDeg`). Лёгкий scatter (Min-band) остаётся 360°.
