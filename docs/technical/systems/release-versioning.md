...
Система определяет версию и воспроизводимый выпуск JAZZ как комплекта из четырёх независимых Git-репозиториев. Она относится к developer/release tooling и не меняет игровые правила.
