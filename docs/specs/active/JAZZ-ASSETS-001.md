...
- `JAZZ-ASSETS-001-AC-006`: `PASS` — human/runtime: владелец подтвердил (2026-07-31), что HMMWV в игре без missing entity/state/material и без collision assert; регрессия была бы заметна.
