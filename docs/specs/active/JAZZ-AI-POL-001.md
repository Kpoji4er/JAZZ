...
- `JAZZ-AI-POL-001-REQ-004` — OptLoc/EndTurn TakeCover Weight: Frontliner 80–150; Assaulter 20–40; Flanker OptLoc ≤20 и Flank-branch EndTurn ≤10 (flank остаётся доминирующим).
...
- `JAZZ-AI-POL-001-AC-002` — static: шесть Id (`Legion_`/`Rebels_` × Frontliner/Assaulter/Flanker) — OptLoc TakeCover Weights в целевых диапазонах REQ-004; ally Proximity с `closer_better`.
...
- `JAZZ-AI-POL-001-AC-002`: `PASS` — static: шесть templates; OptLoc TakeCover Front 80/120, Assault 40, Flank 15; Flank-branch EndTurn TakeCover Weight 1; ally Proximity `closer_better`.
...
- `docs/technical/systems/ai-awareness.md` — TakeCover/Proximity POL-001.
