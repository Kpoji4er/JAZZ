...
Обновлены `combat-cth-actions.md` (секция Grazing), `visibility-weather-appearance.md`, `file-coverage.md`, `testing.md`, `accuracy-model.md`, wiki + showcase RU/EN. Правило синхронизации: `.cursor/rules/jazz-docs-sync.mdc`.
