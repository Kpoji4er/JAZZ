...
| JAZZ-STRATEGY-015 | Medic density: Bonemaker reserved ~1 / 10–20 (min 1 at n≥10, `floor(n/15)`); **Normal +1 / Hard 0 / VeryHard −1** loot skew |
...
**Медики (утверждено, STRATEGY-015):** `JAZZ_Legion_FrontT1_Bonemaker` — при `n≥10` минимум 1, иначе/`далее` `floor(n/15)` (≈1 на 10–20). **Normal +1 / Hard 0 / VeryHard −1** (основной Meds loot). Reserved slots в combat generator; не random line-spam.
