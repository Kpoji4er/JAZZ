...
Это полный справочник основных классов стрелкового оружия: 165 предметов, 148 обычных tiered-вариантов, 10 уникальных и 7 пока без balance-tier. Числа берутся из канонических таблиц документации, а не из Google Sheets.
...
| [undefined](submachine-gun.md) | `SubmachineGun` | 24 | 1, 2, 3 |
| [undefined](carbine.md) | `Carbine` | 15 | 1, 2, 3 |
| [undefined](assault-rifle.md) | `AssaultRifle` | 18 | 1, 2, 3 |
