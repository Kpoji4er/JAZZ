...
## Crafting ammo
Ammo crafting makes only **handloaded** JAZZ rounds and **12-gauge saltshot**. Handloads are not junk below Poor: they are an **alternative to ordinary FMJ** — jam/reliability better than Poor, worse than FMJ, with hollow-point-like crits and a bit more penetration. Factory FMJ/AP/match stay loot and Bobby Ray. Each batch costs **100 Parts** plus powder; yield depends on caliber (9×18=50, 9×19=40, .45=30, intermediate rifle=30, full-power 7.62 and 9×39=20, salt=20).
