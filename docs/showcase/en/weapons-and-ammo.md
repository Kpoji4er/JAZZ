...
| BDR / range | End of the effective zone / hard shot limit. The Overwatch number on the card is cone width **at BDR**; closer is wider, max range is a strip. |
