...
- Frag / HE / flashbang: **guaranteed concussion** on blast-hit units, plus a chance of **zone trauma**. A strong blast can also **knock units back** one tile from the epicenter (mercs included) — **Strength + Health** skill check vs **pre-armor** damage; already prone units stay put. Smoke / gas / Molotov use their own packages, not concussion/knockback.
