...
- **Wound infection**: an untreated **heavy** trauma that fails its improvement check gains **Infected Wound** (the trauma stays). Later infection checks either clear it or **kill** the merc. Field Treat Wounds healing prevents infection from that check.
