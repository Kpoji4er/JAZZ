...
Without the maps package (**JAZZ Vanilla Maps**) the same Global AI runs vanilla mainland outposts: Major HQ at A20, starting defenders adopted as garrison, tax/recruiting from city/farm stockpiles. Enemy gear and container loot scale with Legion tier (mine + 3 days → II, World Flip → III); vanilla generic map legionaries are swapped for JAZZ roles (Bastien stays; Flag Hill WeakFlagHill → T1 Roughneck; Stronger_Elite → T4 mercenaries) — see [Legion units](legion-units.md).
