...
В боевых отрядах Легиона (патруль, гарнизон, разведка, QRF и т.п.) **Костоправ** ставится примерно **1 на 10–20 бойцов** (в отряде от 10 человек — минимум один). У него в луте аптечка.
