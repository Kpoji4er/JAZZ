...
В боевых отрядах Легиона (патруль, гарнизон, разведка, QRF и т.п.) **Костоправ** ставится примерно **1 на 10–20 бойцов** (в отряде от 10 человек — минимум один). У него в луте аптечка и **50 Meds** (удобный источник медикаментов на Treat Wounds). На лёгкой сложности медиков больше, на сложной — меньше.
