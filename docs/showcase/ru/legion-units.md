...
**Материк без maps (NoMaps):** тир **I→II** от **захваченных шахт** (≥1 шахта → II); тир **III** после **World Flip**; подтир — от **числа ваших секторов**. Тир только растёт, не откатывается.
