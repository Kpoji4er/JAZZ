...
Стартовый экип IMP зависит от статов и перков теста (ствол, броня, медикаменты, инструменты). В пуле Personality доступны **Мимикрия**, **Ветеран**, **Снайпер** — см. [перки](perks.md).
