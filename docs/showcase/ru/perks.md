...
| `GloryHog` | PierreMerc | Мачете **Charge** (не только по прямой) +**15** Grit; активка **Вербовка** — одна кнопка, клик по видимому врагу → союзник ИИ / бой (не боссы) |
...
| `BulletHell` | Spike | Конусный ливень 15–30 пуль; попадания по врагу в секторе; **Will всем в конусе**; CD **после убийства** |
