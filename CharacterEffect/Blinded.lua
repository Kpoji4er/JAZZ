...
DefineClass.Blinded = {
	...
	DisplayName = T(629298563884, "Слепота"),
	Description = T(595664130748, "Снижает <em>дальность обзора</em> и <em>точность</em>. Может вызвать <em>панику</em>."),
	AddEffectText = T(880622931884, "<em><DisplayName></em> ничего не видит"),
