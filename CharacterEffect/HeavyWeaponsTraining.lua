...
DefineClass.HeavyWeaponsTraining = {
	...
	DisplayName = T(575851829180, "Тяжелое вооружение"),
	Description = T(415344339832, "Уменьшен расход <em>ОД</em> на атаки из <em>тяжелого вооружения</em> и <em>пулеметов</em> и приведение его в <GameTerm('Setup')>."),
