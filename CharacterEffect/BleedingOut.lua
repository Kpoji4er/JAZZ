...
DefineClass.BleedingOut = {
	...
	DisplayName = T(216716472184, "Тяжелое ранение"),
	Description = T(910957860179, "Этот персонаж находится в <color EmStyle>критическом состоянии</color> и истечет кровью, если его не <color EmStyle>перевязать</color>. Каждый ход персонаж будет терять 8 единиц здоровья."),
