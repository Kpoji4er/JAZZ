...
DefineClass.TakeAim = {
	...
	DisplayName = T(500170452730, "Пристрелка"),
	Description = T(518636342491, "<color EmStyle>Повторные атаки</color> по одной и той же <color EmStyle>цели</color> получают все больший бонус к <color EmStyle>точности</color>."),
