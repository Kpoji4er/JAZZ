...
Канонические Nick (RU) AIM/vanilla, не выдумывай другие транслиты в title/summary:
Wolf → «Вольф» (не «Волк», не «Вульф»); Len → «Лен»; Fox → «Лиса»/игровой Nick из
diff при наличии. «Вульф» в чужих репликах (например Пума) — всё равно тот же Wolf.
Один UnitData id = одно имя во всей сводке.
