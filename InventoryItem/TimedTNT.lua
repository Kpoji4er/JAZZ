...
DefineClass.TimedTNT = {
	...
	ItemType = "Grenade",
	DisplayName = T(133799436971, "Динамит с таймером"),
	DisplayNamePlural = T(789269707920, "Динамит с таймером"),
	AdditionalHint = T(714276674088, "<image UI/Conversation/T_Dialogue_IconBackgroundCircle.tga 400 130 128 120> Взрывается через 1 ход (или 5 секунд не в бою)\n<image UI/Conversation/T_Dialogue_IconBackgroundCircle.tga 400 130 128 120> Высокая вероятность неудачи"),
	UnitStat = "Explosives",
	Cost = 600,
