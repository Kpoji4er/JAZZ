...
DefineClass.Mosin = {
	...
	DisplayName = T(415053102324, "Винтовка Мосина"),
	DisplayNamePlural = T(826420490062, "Винтовки Мосина"),
	Description = T(105734133486, "Основная винтовка советского солдата РККА во время ВОВ. Максимально стрательно была приведена к вариации СН - снят штык, загнута вниз рукоять затвора, приварено посадочное место для прицела. Однако, отсутствие маркировки на стволе выдает самозванку."),
