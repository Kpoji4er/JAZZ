...
DefineClass.KevlarVest_CeramicPlates = {
	...
	DisplayName = T(196362455670, "Кевларовая броня"),
	DisplayNamePlural = T(819102510854, "Кевларовая броня"),
	AdditionalHint = T(904920821332, "<image UI/Conversation/T_Dialogue_IconBackgroundCircle.tga 400 130 128 120> Уменьшение урона (улучшено керамическими пластинами) \n<image UI/Conversation/T_Dialogue_IconBackgroundCircle.tga 400 130 128 120> Керамические пластины ломаются после <color 124 130 96><RevertConditionCounter></color> попаданий"),
	Cost = 5000,
	Tier = 2,
	MaxStock = 1,
	RestockWeight = 25,
