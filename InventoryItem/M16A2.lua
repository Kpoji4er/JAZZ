...
DefineClass.M16A2 = {
	...
	AdditionalHint = T(967388007174, --[[ModItemInventoryItemCompositeDef M16A2 AdditionalHint]] "<image UI/Conversation/T_Dialogue_IconBackgroundCircle.tga 400 130 128 120> Высокая точность при прицельной стрельбе одиночными или очередями\n<image UI/Conversation/T_Dialogue_IconBackgroundCircle.tga 400 130 128 120> Отсутствует режим автоматического огня"),
	LargeItem = 1,
