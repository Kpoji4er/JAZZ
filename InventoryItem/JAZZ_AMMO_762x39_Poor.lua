...
DefineClass.JAZZ_AMMO_762x39_Poor = {
	...
	Description = T(296646736495, --[[ModItemInventoryItemCompositeDef JAZZ_AMMO_762x39_Poor Description]] "Китайский патрон калибра 7.62х39. Сурплюсная партия - дешёвая и рабочая, часто встречается в странах с большим количеством старых запасов. Надёжен, но не самый точный."),
	Cost = 270,
