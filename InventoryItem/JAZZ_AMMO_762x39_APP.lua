...
DefineClass.JAZZ_AMMO_762x39_APP = {
	...
	Description = T(527669776671, --[[ModItemInventoryItemCompositeDef JAZZ_AMMO_762x39_APP Description]] "Бронебойный вариант 7.62×39 - предназначен для пробития легкой брони и барьеров."),
	Cost = 3000,
