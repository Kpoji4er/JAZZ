...
DefineClass.Knife_Sharpened = {
	...
	DisplayName = T(515703351409, "Заточенный нож"),
	DisplayNamePlural = T(589780714318, "Заточенные ножи"),
	Description = T(995060755349, "Что может быть лучше ближнего боя?"),
	AdditionalHint = T(481262160237, "<image UI/Conversation/T_Dialogue_IconBackgroundCircle.tga 400 130 128 120> Заточенное: высокий урон\n<image UI/Conversation/T_Dialogue_IconBackgroundCircle.tga 400 130 128 120> Низкая цена атаки"),
	UnitStat = "Dexterity",
	Cost = 1200,
