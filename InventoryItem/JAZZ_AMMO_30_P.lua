...
DefineClass.JAZZ_AMMO_30_P = {
	...
	Description = T(285060449915, --[[ModItemInventoryItemCompositeDef JAZZ_AMMO_30_P Description]] "Повышенного давления патрон для тестирования или специальных применений; применять в штатном оружии нужно с осторожностью."),
	Cost = 540,
