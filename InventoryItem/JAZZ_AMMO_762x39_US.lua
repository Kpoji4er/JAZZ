...
DefineClass.JAZZ_AMMO_762x39_US = {
	...
	Description = T(317343617056, --[[ModItemInventoryItemCompositeDef JAZZ_AMMO_762x39_US Description]] "Тяжёлый замедленный патрон для тихой стрельбы - подходит для глушителей и специальных задач. Жертвуешь скоростью ради бесшумности."),
	Cost = 900,
