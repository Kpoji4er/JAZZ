...
DefineClass.JAZZ_AMMO_762x51_Army = {
	...
	Description = T(296800783973, --[[ModItemInventoryItemCompositeDef JAZZ_AMMO_762x51_Army Description]] "Стандартный армейский патрон М80 калибра 7.62х51мм НАТО"),
	AdditionalHint = T(623835325820, --[[ModItemInventoryItemCompositeDef JAZZ_AMMO_762x51_Army AdditionalHint]] "<image UI/Conversation/T_Dialogue_IconBackgroundCircle.tga 400 130 128 120> Обеспечивает уверенное поражение целей обладающих 3-м классом брони"),
	Cost = 1800,
