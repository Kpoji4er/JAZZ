...
DefineClass.HeavyArmorLeggings_Kompositum = {
	...
	DisplayName = T(842175480143, "Тяжелые поножи с композитумом"),
	DisplayNamePlural = T(141587408909, "Тяжелые поножи с композитумом"),
	AdditionalHint = T(759827329147, "<image UI/Conversation/T_Dialogue_IconBackgroundCircle.tga 400 130 128 120> Громоздкое (нет бесплатного перемещения)\n<image UI/Conversation/T_Dialogue_IconBackgroundCircle.tga 400 130 128 120> Совмещено с композитумом-58"),
	Cumbersome = 1,
	Valuable = 1,
	Cost = 4300,
	Tier = 3,
