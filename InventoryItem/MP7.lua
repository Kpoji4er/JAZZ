...
DefineClass.MP7 = {
	...
	DisplayName = T(584704183227, "MP7"),
	DisplayNamePlural = T(150579573516, "MP7"),
	Description = T(174939633208, "Прямой конкурент бельгийского P90 за звание главного PDWаста в блоке НАТО. Внутри устроен как настоящая большая винтовка, что дает неплохую мощность при использовании патронов малого калибра. "),
	AdditionalHint = T(142265159773, "<image UI/Conversation/T_Dialogue_IconBackgroundCircle.tga 400 130 128 120> Пробивает броню второго класса\n<image UI/Conversation/T_Dialogue_IconBackgroundCircle.tga 400 130 128 120> Высокая скорострельность\n<image UI/Conversation/T_Dialogue_IconBackgroundCircle.tga 400 130 128 120> Одноручное"),
