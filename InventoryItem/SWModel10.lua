...
DefineClass.SWModel10 = {
	...
	Description = T(878461703337, --[[ModItemInventoryItemCompositeDef SWModel10 Description]] "Баюн не сделал описание этому предмету :("),
	AdditionalHint = T(434107786112, --[[ModItemInventoryItemCompositeDef SWModel10 AdditionalHint]] "Баюн не сделал описание этому предмету :("),
