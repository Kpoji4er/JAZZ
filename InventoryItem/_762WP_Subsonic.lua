...
DefineClass._762WP_Subsonic = {
	...
	DisplayName = T(705582625224, "7,62х39мм, УС"),
	DisplayNamePlural = T(194372616955, "7,62х39мм, УС"),
	colorStyle = "AmmoBasicColor",
	Description = T(337151148241, "Специальный советский дозвуковой патрон УС калибра 7.62х39мм"),
	AdditionalHint = T(468738881554, "<image UI/Conversation/T_Dialogue_IconBackgroundCircle.tga 400 130 128 120> Обеспечивает уверенное поражение целей обладающих 2-м классом брони\n<image UI/Conversation/T_Dialogue_IconBackgroundCircle.tga 400 130 128 120> Дозвуковые: пониженный урон, уменьшенная дальность, уменьшенная точность, уменьшенная громкость выстрела, увеличенная надежность"),
	Cost = 350,
	RestockWeight = 25,
	CategoryPair = "762WP",
	ShopStackSize = 30,
