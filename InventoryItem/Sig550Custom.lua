...
DefineClass.Sig550Custom = {
	...
	AdditionalHint = T(155361024222, --[[ModItemInventoryItemCompositeDef Sig550Custom AdditionalHint]] "<image UI/Conversation/T_Dialogue_IconBackgroundCircle.tga 400 130 128 120> Высокая эффективность при стрельбе очередями\n<image UI/Conversation/T_Dialogue_IconBackgroundCircle.tga 400 130 128 120> Возможности модификаций"),
	LargeItem = 1,
