...
DefineClass.Knife_Balanced = {
	...
	DisplayName = T(558360625902, "Сбалансированный нож"),
	DisplayNamePlural = T(288113994061, "Сбалансированные ножи"),
	Description = T(816876181011, "Что может быть лучше ближнего боя?"),
	AdditionalHint = T(337666095722, "<image UI/Conversation/T_Dialogue_IconBackgroundCircle.tga 400 130 128 120> Сбалансированное: увеличенная дальность броска\n<image UI/Conversation/T_Dialogue_IconBackgroundCircle.tga 400 130 128 120> Сбалансированное: увеличенная эффективность прицеливания\n<image UI/Conversation/T_Dialogue_IconBackgroundCircle.tga 400 130 128 120> Низкая цена атаки"),
	UnitStat = "Dexterity",
	Cost = 1200,
