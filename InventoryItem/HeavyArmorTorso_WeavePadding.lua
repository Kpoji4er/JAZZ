...
DefineClass.HeavyArmorTorso_WeavePadding = {
	...
	DisplayName = T(515134387293, "Тяжелая броня"),
	DisplayNamePlural = T(731006551250, "Тяжелая броня"),
	AdditionalHint = T(190771851393, "<image UI/Conversation/T_Dialogue_IconBackgroundCircle.tga 400 130 128 120> Уменьшение урона (улучшено обивкой)\n<image UI/Conversation/T_Dialogue_IconBackgroundCircle.tga 400 130 128 120> Громоздкое (нет бесплатного перемещения)"),
	Cumbersome = 1,
	Valuable = 1,
	Cost = 10000,
	Tier = 3,
