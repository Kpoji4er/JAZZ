...
DefineClass.SmokeGrenade = {
	...
	ItemType = "Throwables",
	DisplayName = T(529889768393, "Дымовая граната"),
	DisplayNamePlural = T(564232117531, "Дымовые гранаты"),
	AdditionalHint = T(206588175055, "<image UI/Conversation/T_Dialogue_IconBackgroundCircle.tga 400 130 128 120> Выстрелы, совершенные сквозь облака газа, дают лишь <color EmStyle>незначительные попадания</color>\n<image UI/Conversation/T_Dialogue_IconBackgroundCircle.tga 400 130 128 120> Не наносит урона\n<image UI/Conversation/T_Dialogue_IconBackgroundCircle.tga 400 130 128 120> Почти бесшумна"),
	UnitStat = "Explosives",
	Cost = 300,
