...
DefineClass.Parts = {
	...
	DisplayName = T(446617998255, "Запчасти"),
	DisplayNamePlural = T(527810279336, "Запчасти"),
	AdditionalHint = T(683993796357, "<image UI/Conversation/T_Dialogue_IconBackgroundCircle.tga 400 130 128 120> Используются для модификации оружия\n<image UI/Conversation/T_Dialogue_IconBackgroundCircle.tga 400 130 128 120> Используются для операции «Ремонт предметов» в виде со спутника."),
	Cost = 250,
