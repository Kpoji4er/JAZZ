...
DefineClass.JAZZ_AMMO_556_Match = {
	...
	Description = T(886365993358, --[[ModItemInventoryItemCompositeDef JAZZ_AMMO_556_Match Description]] "Матчевый патрон повышенной точности для снайперских и прицельных задач. Дорогой, но оправдан в задачах, где важна кучность."),
	AdditionalHint = "",
	Cost = 3600,
