...
DefineClass.JAZZ_AMMO_792_AP = {
	...
	Description = T(634152164577, --[[ModItemInventoryItemCompositeDef JAZZ_AMMO_792_AP Description]] "Бронебойный бронеснаряд для 7.92×57 - используется против укреплений и лёгкой брони."),
	AdditionalHint = "",
	Cost = 1080,
