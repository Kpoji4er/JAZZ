...
DefineClass.JAZZ_AMMO_762x39_FMJ = {
	...
	Description = T(296646736495, --[[ModItemInventoryItemCompositeDef JAZZ_AMMO_762x39_FMJ Description]] "Китайский коммерческий полнооболочечный патрон - универсален и предсказуем по поведению."),
