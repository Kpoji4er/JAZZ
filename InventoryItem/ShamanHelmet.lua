...
DefineClass.ShamanHelmet = {
	...
	DisplayName = T(334357176944, "Шлем «Отряда смерти»"),
	DisplayNamePlural = T(619349093375, "Шлемы «Отряда смерти»"),
	Description = T(821984487782, 'Личный шлем шамана Сангомы, принадлежавший ему еще в тот период, когда Сангома был в составе печального известного "Отряда Смерти". К обычному военному шлему добавлена баллистическая маска в агрессивной раскраске в форме черепа, призванная оказывать психологический эффект на противников Сангомы.'),
	AdditionalHint = "",
	Valuable = 1,
	RestockWeight = 0,
	Slot = "Head",
