...
DefineClass.JAZZ_AMMO_3006_Match = {
	...
	Description = T(898567748151, --[[ModItemInventoryItemCompositeDef JAZZ_AMMO_3006_Match Description]] "Матчевый/снайперский патрон .30-06 с улучшенной кучностью и стабильностью баллистики на дальних дистанциях. Предназначен для точной стрельбы и специализированных задач; стоит дороже стандартных боеприпасов, но оправдан в миссиях, где важна точность."),
	Cost = 840,
