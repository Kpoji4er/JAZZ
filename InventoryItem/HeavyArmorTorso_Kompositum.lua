...
DefineClass.HeavyArmorTorso_Kompositum = {
	...
	DisplayName = T(615129134579, "Тяжелая броня с композитумом"),
	DisplayNamePlural = T(126914512957, "Тяжелая броня с композитумом"),
	AdditionalHint = T(347531284201, "<image UI/Conversation/T_Dialogue_IconBackgroundCircle.tga 400 130 128 120> Громоздкое (нет бесплатного перемещения)\n<image UI/Conversation/T_Dialogue_IconBackgroundCircle.tga 400 130 128 120> Совмещено с композитумом-58"),
	Cumbersome = 1,
	Valuable = 1,
	Cost = 5500,
	Tier = 2,
