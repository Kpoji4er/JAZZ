...
DefineClass.JAZZ_AMMO_792x33_AP = {
	...
	Description = T(527669776671, --[[ModItemInventoryItemCompositeDef JAZZ_AMMO_792x33_AP Description]] "Бронебойная версия исторического патрона - повышенная пробивная способность для своей эпохи. Редкий и коллекционный."),
	AdditionalHint = "",
	Cost = 1350,
