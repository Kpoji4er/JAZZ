...
DefineClass.RemoteTNT = {
	...
	ItemType = "Grenade",
	DisplayName = T(916239488271, "Дистанционный динамит"),
	DisplayNamePlural = T(180231082583, "Дистанционный динамит"),
	AdditionalHint = T(436102360957, "<image UI/Conversation/T_Dialogue_IconBackgroundCircle.tga 400 130 128 120> Заряд подрывается с помощью пульта ДУ\n<image UI/Conversation/T_Dialogue_IconBackgroundCircle.tga 400 130 128 120> Высокая вероятность неудачи"),
	UnitStat = "Explosives",
	Cost = 600,
