...
DefineClass.JAZZ_AMMO_556_FMJ = {
	...
	Description = T(790646713962, --[[ModItemInventoryItemCompositeDef JAZZ_AMMO_556_FMJ Description]] "Стандартная армейская/коммерческая оболочечная загрузка - надёжная и массовая. Баланс цены и эффективности для боевых и тренировочных нужд."),
	AdditionalHint = "",
	Cost = 1200,
