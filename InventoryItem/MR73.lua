...
DefineClass.MR73 = {
	...
	Description = T(878461703337, "Штатный револьвер французской полиции и даже полицейского спезнаца. Качество изготовления ощутимо выше, чем у ширпотреба вроде револьверов Colt, так что на эту пушку вполен можно положиться в самый трудный момент."),
