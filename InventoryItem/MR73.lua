...
DefineClass.MR73 = {
	...
	Description = T(878461703337, --[[ModItemInventoryItemCompositeDef MR73 Description]] "Баюн не сделал описание этому предмету :("),
	AdditionalHint = T(434107786112, --[[ModItemInventoryItemCompositeDef MR73 AdditionalHint]] "Баюн не сделал описание этому предмету :("),
