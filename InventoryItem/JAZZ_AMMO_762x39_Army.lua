...
DefineClass.JAZZ_AMMO_762x39_Army = {
	...
	Description = T(527669776671, --[[ModItemInventoryItemCompositeDef JAZZ_AMMO_762x39_Army Description]] "Стандартная армейская партия - баланс цены и надёжности, массово используется в военных платформах."),
	Cost = 840,
