...
DefineClass.JAZZ_AMMO_50BMG_API_HEI = {
	...
	Description = T(642491927546, --[[ModItemInventoryItemCompositeDef JAZZ_AMMO_50BMG_API_HEI Description]] "Разрывной боеприпас для пулеметов, снайперских винтовок, пистолетов и револьверов калибра .50."),
	AdditionalHint = T(549125160319, --[[ModItemInventoryItemCompositeDef JAZZ_AMMO_50BMG_API_HEI AdditionalHint]] "<image UI/Conversation/T_Dialogue_IconBackgroundCircle.tga 400 130 128 120> Нулевая бронебойность\n<image UI/Conversation/T_Dialogue_IconBackgroundCircle.tga 400 130 128 120> Высокий шанс критического попадания"),
	Cost = 13500,
