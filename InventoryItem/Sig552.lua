...
DefineClass.Sig552 = {
	...
	DisplayName = T(829842196548, "Sig 552"),
	DisplayNamePlural = T(668776562271, "Sig 552"),
	Description = T(264662710858, "Ультракомпактный автомат производства SIG с классической компоновкой и не менее классической газоотводной системой. Серьезное дорогое оружие."),
	AdditionalHint = T(859037642619, "<image UI/Conversation/T_Dialogue_IconBackgroundCircle.tga 400 130 128 120> Можно использовать для стрельбы на бегу\n<image UI/Conversation/T_Dialogue_IconBackgroundCircle.tga 400 130 128 120> Высокая точность\n<image UI/Conversation/T_Dialogue_IconBackgroundCircle.tga 400 130 128 120> Низкая отдача"),
	LargeItem = 1,
