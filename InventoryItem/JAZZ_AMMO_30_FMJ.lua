...
DefineClass.JAZZ_AMMO_30_FMJ = {
	...
	Description = T(285060449915, --[[ModItemInventoryItemCompositeDef JAZZ_AMMO_30_FMJ Description]] "Стандартный боевой патрон для карабинов времен WWII - простой и надёжный. Подойдёт для исторической техники и гражданской винтажной стрельбы."),
	Cost = 360,
