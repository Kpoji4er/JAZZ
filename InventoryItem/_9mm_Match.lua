...
DefineClass._9mm_Match = {
	...
	DisplayName = T(557669429065, "9х19 мм, Match"),
	DisplayNamePlural = T(909118059097, "9х19 мм, Match"),
	colorStyle = "AmmoMatchColor",
	Description = T(203032964857, "Матчевый патрон калибра 9х19мм"),
	AdditionalHint = T(169382118769, "<image UI/Conversation/T_Dialogue_IconBackgroundCircle.tga 400 130 128 120> Увеличенная эффективность прицеливания\n<image UI/Conversation/T_Dialogue_IconBackgroundCircle.tga 400 130 128 120> Повышенный шанс критического попадания\n<image UI/Conversation/T_Dialogue_IconBackgroundCircle.tga 400 130 128 120> Увеличенная дальность стрельбы без штрафов"),
	Cost = 350,
	MaxStock = 15,
	RestockWeight = 25,
	CategoryPair = "9mm",
