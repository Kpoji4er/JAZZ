...
DefineClass.PipeBomb = {
	...
	ItemType = "Grenade",
	DisplayName = T(584678244008, "Самодельная бомба"),
	DisplayNamePlural = T(604631052255, "Самодельные бомбы"),
	AdditionalHint = T(738342557339, "<image UI/Conversation/T_Dialogue_IconBackgroundCircle.tga 400 130 128 120> Взрывается через 1 ход (или 5 секунд не в бою)\n<image UI/Conversation/T_Dialogue_IconBackgroundCircle.tga 400 130 128 120> Высокая вероятность неудачи\n<image UI/Conversation/T_Dialogue_IconBackgroundCircle.tga 400 130 128 120> Вызывает кровотечение"),
	UnitStat = "Explosives",
	Cost = 100,
