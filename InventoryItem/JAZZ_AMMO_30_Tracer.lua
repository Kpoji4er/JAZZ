...
DefineClass.JAZZ_AMMO_30_Tracer = {
	...
	Description = T(285060449915, --[[ModItemInventoryItemCompositeDef JAZZ_AMMO_30_Tracer Description]] "Стандартный боевой патрон для карабинов времен WWII - простой и надёжный. Подойдёт для исторической техники и гражданской винтажной стрельбы."),
	Cost = 540,
