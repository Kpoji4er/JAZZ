...
DefineClass.CamoArmor_Light_Kompositum = {
	...
	DisplayName = T(925164820871, "Лег. камуфляжная броня с композитумом"),
	DisplayNamePlural = T(216023440060, "Лег. камуфляжная броня с композитумом"),
	AdditionalHint = T(940302072624, "<image UI/Conversation/T_Dialogue_IconBackgroundCircle.tga 400 130 128 120> Усложняет обнаружение противником\n<image UI/Conversation/T_Dialogue_IconBackgroundCircle.tga 400 130 128 120> Против камуфлированных целей прицеливание работает хуже\n<image UI/Conversation/T_Dialogue_IconBackgroundCircle.tga 400 130 128 120> Совмещена с композитумом-58"),
	Cost = 4500,
	Tier = 2,
	MaxStock = 1,
	RestockWeight = 25,
