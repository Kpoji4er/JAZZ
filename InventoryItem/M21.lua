...
DefineClass.M21 = {
	...
	AdditionalHint = T(341847967956, --[[ModItemInventoryItemCompositeDef M21 AdditionalHint]] "<image UI/Conversation/T_Dialogue_IconBackgroundCircle.tga 400 130 128 120> Снайперская версия м14\n<image UI/Conversation/T_Dialogue_IconBackgroundCircle.tga 400 130 128 120> Низкая надежность"),
	LargeItem = 1,
