...
DefineClass.RPK = {
	...
	DisplayName = T(940541298260, "РПК"),
	DisplayNamePlural = T(300104203548, "РПК"),
	Description = T(682256467954, "Ручной пулемет, созданный на платформе АК: конструкторы поставили ствол потолще и еще несколько модификаций, чтобы РПК мог вести непрерывный огонь. Этот пулемет должен был занять роль оружия поддержки на уровне взвода, учитывая простоту использования и совместимость магазинов с остальными «калашами»."),
	AdditionalHint = T(858142642339, "<image UI/Conversation/T_Dialogue_IconBackgroundCircle.tga 400 130 128 120> Легкий (без бубна)"),
	LargeItem = 1,
