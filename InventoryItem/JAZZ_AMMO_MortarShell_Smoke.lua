...
DefineClass.JAZZ_AMMO_MortarShell_Smoke = {
	...
	DisplayName = T(935097971760, --[[ModItemInventoryItemCompositeDef JAZZ_AMMO_MortarShell_Smoke DisplayName]] "Дым. выстрел миномета"),
	...
	AdditionalHint = T(140416387512, --[[ModItemInventoryItemCompositeDef JAZZ_AMMO_MortarShell_Smoke AdditionalHint]] "<image UI/Conversation/T_Dialogue_IconBackgroundCircle.tga 400 130 128 120> Выстрелы, совершенные сквозь облака газа, дают лишь <color EmStyle>незначительные попадания</color>\n<image UI/Conversation/T_Dialogue_IconBackgroundCircle.tga 400 130 128 120> Не наносит урона\n<image UI/Conversation/T_Dialogue_IconBackgroundCircle.tga 400 130 128 120> Почти бесшумно"),
	Cost = 750,
	Tier = 2,
	MaxStock = 10,
	RestockWeight = 25,
