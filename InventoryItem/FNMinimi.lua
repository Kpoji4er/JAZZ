...
DefineClass.FNMinimi = {
	...
	AdditionalHint = T(270977662171, --[[ModItemInventoryItemCompositeDef FNMinimi AdditionalHint]] "<image UI/Conversation/T_Dialogue_IconBackgroundCircle.tga 400 130 128 120> Легкий\n<image UI/Conversation/T_Dialogue_IconBackgroundCircle.tga 400 130 128 120> Очень высокая скорострельность"),
	LargeItem = 1,
