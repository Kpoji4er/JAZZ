...
DefineClass.Glock18 = {
	...
	DisplayName = T(876495756178, "Glock 18"),
	DisplayNamePlural = T(478389428053, "Glock 18"),
	Description = T(594387443300, "Glock 17 с переключателем в режим безудержного веселья и встроенным компенсатором. Автоматическая игрушка под патрон 9x19мм!"),
	AdditionalHint = T(358502954241, "<image UI/Conversation/T_Dialogue_IconBackgroundCircle.tga 400 130 128 120> Бонус при стрельбе навскидку\n<image UI/Conversation/T_Dialogue_IconBackgroundCircle.tga 400 130 128 120> Особый режим стрельбы: короткая очередь\n<image UI/Conversation/T_Dialogue_IconBackgroundCircle.tga 400 130 128 120> Возможность модификаций"),
