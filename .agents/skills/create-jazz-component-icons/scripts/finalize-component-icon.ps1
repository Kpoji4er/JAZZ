# Finalize WeaponComponent.Icon draft → Icons/Upgrades/Full/<ComponentId>.png (128×128)
# Usage:
#   finalize-component-icon.ps1 -SourceDraft "draft.png" -ComponentId AdvancedHOLO
...
if (-not $OutDir) {
  $OutDir = Join-Path $repo "Icons\Upgrades\Full"
}
New-Item -ItemType Directory -Force -Path $OutDir | Out-Null

$safeId = $ComponentId.Trim()
if ($safeId -notmatch '^[A-Za-z0-9_]+$') {
  throw "ComponentId must be alphanumeric/underscore: $ComponentId"
}
