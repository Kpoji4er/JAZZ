...
| Видимое игроку правило, формула, action, item или status | Профильная системная страница и связанная spec | `testing.md`, если меняется общий validation profile |
...
`docs/wiki` сейчас отсутствует и не является частью Definition of Done. Не создавать ссылки на него до отдельного ADR о восстановлении пользовательского контура.
...
5. `docs/README.md` ведёт к specs, decisions и technical.
