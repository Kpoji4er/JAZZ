...
- Новый building slab (стена/пол/крыша со своими мешами и текстурами) — гайд: `docs/design/ja3-how-to-custom-slabs.md`. Предпочтительно отдельный мод (не `jazz_assets`); комнаты на картах только выбирают `id`. Своих slab-материалов в JAZZ пока нет.
