...
- Новый building slab (стена/пол/крыша со своими мешами и текстурами) — how-to по движку JA3: `docs/design/ja3-how-to-custom-slabs.md`. Entity и пресет материала — `jazz_assets`; комнаты на картах только выбирают `id`. Своих slab-материалов в JAZZ пока нет.
