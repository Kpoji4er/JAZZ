...
--UndefineClass("SquadBagItem")
--DefineClass.SquadBagItem = { __parents = { "InventoryItem", "QuickSlotItem", "Medicine","ThrowableTrapItem", "Flare" } }

UndefineClass("ConditionAndRepair")
DefineClass.ConditionAndRepair = { __parents = { "QuickSlotItem", "CapacityItemProperties", "SquadBagItem" } }
--
--UndefineClass("Valuables")
--DefineClass.Valuables = { __parents = { "InventoryItem", "SquadBagItem" } }
--
UndefineClass("ValuablesStack")
DefineClass.ValuablesStack = { __parents = { "Valuables", "InventoryStack", "SquadBagItem" } }
--
--UndefineClass("ValuableItemContainer")
--DefineClass.ValuableItemContainer = { __parents = { "InventoryItem", "SquadBagItem" } }
--
UndefineClass("QuickSlotItem")
DefineClass.QuickSlotItem = { __parents = { "InventoryItem", "SquadBagItem" } }
--UndefineClass("Medicine")
--DefineClass.Medicine = { __parents = { "InventoryItem", "BobbyRayShopOtherProperties", "SquadBagItem"},
--	properties = {
...
--}
--
--UndefineClass("ToolItem")
--DefineClass.ToolItem = {
--	__parents = { "InventoryItem", "BobbyRayShopOtherProperties", "SquadBagItem" },
--	properties = {
...
UndefineClass("MiscItem")
DefineClass.MiscItem = {
	__parents = {"InventoryStack", "MiscItemProperties", "BobbyRayShopOtherProperties", "SquadBagItem" }
}

UndefineClass("ExplosiveSubstance")
DefineClass.ExplosiveSubstance = {
	__parents = { "InventoryStack", "TrapExplosionProperties", "BobbyRayShopOtherProperties", "SquadBagItem" },
	properties = {
...
UndefineClass("SquadBag")
DefineClass.SquadBag = {
	__parents = { "Inventory" },
	inventory_slots = {
--		{slot_name = "Inventory",  width = 7,large_with = 9, height = 1, base_class = "InventoryItem", enabled = true },
		{slot_name = "Inventory",  width = 7,large_with = 13, height = 1, base_class = "SquadBagItem", enabled = true },
	},
	squad_id = false,
