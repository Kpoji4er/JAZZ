...
-- This Code file is the editable source; re-run docs/tools/_install_ame_xtemplate_moditem.py
...
PlaceObj('XTemplate', {
	...
	PlaceObj('XTemplateWindow', {
		...
		PlaceObj('XTemplateFunc', {
			'name', "Open",
			'func', function (self, ...)
				PDAAIMEBrowser.Open(self,...)
				AddPageToBrowserHistory("ame", nil)
			end,
		}),
		PlaceObj('XTemplateFunc', {
			'name', "Done(self, ...)",
			'func', function (self, ...)
				PDAAIMEBrowser.Done(self,...)
			end,
		}),
		PlaceObj('XTemplateWindow', {
		...
		PlaceObj('XTemplateWindow', {
			...
			'Dock', "box",
			'Image', "Mod/e6L4ECj/Icons/PDA/AME_PdaBackdrop.png",
			'ImageFit', "stretch",
			'ImageColor', RGBA(255, 230, 190, 255),
		}),
		PlaceObj('XTemplateWindow', {
			...
			PlaceObj('XTemplateWindow', {
				...
				PlaceObj('XTemplateWindow', {
					...
					'__context', function (parent, context) return GetAMEScreenFilters() end,
					'Id', "idFilters",
					'MinHeight', 44,
					'MaxHeight', 44,
					'LayoutMethod', "HList",
					...
					PlaceObj('XTemplateWindow', {
						...
						'Background', RGBA(168, 128, 72, 255),
					}),
					PlaceObj('XTemplateForEach', {
						...
						PlaceObj('XTemplateWindow', {
							...
							'Translate', true,
							'Text', T(440475746284, --[[XTemplate PDAAIMEBrowser Text]] "<name>"),
					...
					PlaceObj('XTemplateWindow', {
						...
						'Translate', true,
						'Text', T(712245129915, --[[XTemplate PDAAIMEBrowser Text]] "<LB> <RB> - Change category"),
					}),
					}),
				PlaceObj('XTemplateWindow', {
					'comment', "AME mark",
					...
					'MinHeight', 64,
					'MaxHeight', 72,
					'Image', "Mod/e6L4ECj/Icons/PDA/AME_Mark.png",
					'ImageFit', "height",
				}),
				}),
			PlaceObj('XTemplateWindow', {
				...
				PlaceObj('XTemplateWindow', {
					...
					'Background', RGBA(186, 150, 92, 255),
				}),
				PlaceObj('XTemplateWindow', {
					...
					PlaceObj('XTemplateWindow', {
						...
						PlaceObj('XTemplateWindow', nil, {
							PlaceObj('XTemplateWindow', {
								...
								'FrameBox', box(3, 3, 3, 3),
								'Background', RGBA(172, 132, 74, 255),
							}),
							PlaceObj('XTemplateWindow', {
								...
								PlaceObj('XTemplateWindow', {
									...
									'MinHeight', 46,
									'MaxHeight', 46,
									'Image', "Mod/e6L4ECj/Icons/PDA/AME_BannerPad.png",
									'ImageFit', "stretch",
								}),
								PlaceObj('XTemplateWindow', {
									'Margins', box(0, 5, 0, 0),
									...
									PlaceObj('XTemplateWindow', {
										...
										'Translate', true,
										'Text', T(266087238479, --[[XTemplate PDAAIMEBrowser Text]] "Bank Account"),
									}),
									PlaceObj('XTemplateWindow', {
								...
								PlaceObj('XTemplateWindow', nil, {
									PlaceObj('XTemplateWindow', {
										...
										PlaceObj('XTemplateWindow', {
											...
											'Translate', true,
											'Text', T(351463573859, --[[XTemplate PDAAIMEBrowser Text]] "<MercLevel()>"),
										}),
										PlaceObj('XTemplateWindow', {
											'__class', "XText",
											'HAlign', "center",
											...
											'Translate', true,
											'Text', T(141041371501, --[[XTemplate PDAAIMEBrowser Text]] "Level"),
										}),
										}),
									PlaceObj('XTemplateWindow', {
										...
										PlaceObj('XTemplateWindow', {
											...
											PlaceObj('XTemplateWindow', {
												...
												'TextStyle', "MercName",
												'Translate', true,
												'Text', T(672662514512, --[[XTemplate PDAAIMEBrowser Text]] "<Name> <MercFlagImage()>"),
												'TextVAlign', "bottom",
												'ImageScale', 1000,
												'SafeSpace', 70,
											}),
								...
								PlaceObj('XTemplateWindow', {
									...
									PlaceObj('XTemplateForEach', {
										...
										PlaceObj('XTemplateWindow', {
											...
											'RolloverText', T(157340803747, --[[XTemplate PDAAIMEBrowser RolloverText]] "<help>"),
											'RolloverOffset', box(0, 0, 0, 5),
											'RolloverTitle', T(976520897583, --[[XTemplate PDAAIMEBrowser RolloverTitle]] "<name>"),
											'IdNode', true,
										}, {
											PlaceObj('XTemplateWindow', {
							...
							PlaceObj('XTemplateWindow', {
								...
								PlaceObj('XTemplateWindow', {
									...
									PlaceObj('XTemplateWindow', {
										...
										'Translate', true,
										'Text', T(890000000000305, --[[XTemplate PDAAIMEBrowser Text]] " "),
									}),
									PlaceObj('XTemplateWindow', {
										'__class', "XFrame",
										'Id', "idLineSep",
								...
								PlaceObj('XTemplateWindow', {
									...
									PlaceObj('XTemplateWindow', {
										...
										'RolloverTemplate', "RolloverGeneric",
										'RolloverAnchor', "center-top",
										'RolloverText', T(882683505602, --[[XTemplate PDAAIMEBrowser RolloverText]] "<MercPriceBioPageRollover()>"),
										'RolloverOffset', box(0, 0, 60, 10),
										'RolloverTitle', T(457158173170, --[[XTemplate PDAAIMEBrowser RolloverTitle]] "Weekly Cost"),
										'Id', "idValue",
										'HAlign', "right",
										'VAlign', "center",
										'TextStyle', "PDAMercPrice",
										'Translate', true,
										'Text', T(196392143876, --[[XTemplate PDAAIMEBrowser Text]] "<MercPriceBioPage(7, true)>"),
										'TextVAlign', "center",
									}),
									}),
								}),
							...
							PlaceObj('XTemplateWindow', {
								...
								PlaceObj('XTemplateWindow', {
									...
									PlaceObj('XTemplateWindow', {
										...
										'TextStyle', "Hiring_Bio_Header",
										'Translate', true,
										'Text', T(550507290667, --[[XTemplate PDAAIMEBrowser Text]] "Equipment"),
										'TextVAlign', "center",
									}),
									PlaceObj('XTemplateWindow', {
										'LayoutMethod', "HWrap",
								...
								PlaceObj('XTemplateWindow', {
									...
									PlaceObj('XTemplateWindow', {
										...
										'TextStyle', "Hiring_Bio_Header",
										'Translate', true,
										'Text', T(801008989746, --[[XTemplate PDAAIMEBrowser Text]] "Backpack"),
										'TextVAlign', "center",
									}),
									PlaceObj('XTemplateWindow', {
										'__class', "XInventoryItemEmbed",
						...
						PlaceObj('XTemplateWindow', {
							...
							PlaceObj('XTemplateWindow', nil, {
								PlaceObj('XTemplateWindow', {
									...
									'TextStyle', "Hiring_Bio_Header",
									'Translate', true,
									'Text', T(642133584014, --[[XTemplate PDAAIMEBrowser Text]] "BIO - <Title>"),
								}),
								PlaceObj('XTemplateWindow', {
									'__class', "XScrollArea",
									'Id', "idBioContent",
		...
		PlaceObj('XTemplateWindow', nil, {
			PlaceObj('XTemplateAction', {
				...
				'ActionId', "idContact",
				'ActionName', T(284104494351, --[[XTemplate PDAAIMEBrowser ActionName]] "Contact"),
				...
				'ActionState', function (self, host)
					...
					if not IsKindOf(content, "PDAAIMEBrowser") then return end
			...
			PlaceObj('XTemplateAction', {
				...
				'RolloverOffset', box(0, 0, 0, 8),
				'ActionId', "idDismiss",
				'ActionName', T(163956682203, --[[XTemplate PDAAIMEBrowser ActionName]] "Dismiss"),
				'ActionToolbar', "ActionBar",
				'ActionButtonTemplate', "PDACommonButtonBlueSnype",
				'ActionState', function (self, host)
					local content = host.idContent
			...
			PlaceObj('XTemplateAction', {
				'ActionId', "idSeeBio",
				'ActionName', T(529989041592, --[[XTemplate PDAAIMEBrowser ActionName]] "See Bio"),
				'ActionToolbar', "ActionBar",
				'ActionShortcut', "S",
				'ActionState', function (self, host)
					local content = host.idContent
			...
			PlaceObj('XTemplateAction', {
				'ActionId', "idHideBio",
				'ActionName', T(872907861571, --[[XTemplate PDAAIMEBrowser ActionName]] "Loadout"),
				'ActionToolbar', "ActionBar",
				'ActionShortcut', "S",
				'ActionState', function (self, host)
					local content = host.idContent
			...
			PlaceObj('XTemplateAction', {
				...
				'OnAction', function (self, host, source, ...)
					...
					if not IsKindOf(content, "PDABrowser") then return end
					content = content.idBrowserContent
					if not IsKindOf(content, "PDAAIMEBrowser") or not content.idMercData then return end
