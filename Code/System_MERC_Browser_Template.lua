...
-- This Code file is the editable source; re-run docs/tools/_install_merc_xtemplate_moditem.py
-- after edits. Do NOT list this file in metadata.code — PlaceObj XTemplate from Code
-- does not reliably register into XTemplates (black screen / "XTemplate not found").
...
PlaceObj('XTemplate', {
	...
	PlaceObj('XTemplateWindow', {
		...
		PlaceObj('XTemplateFunc', {
			'name', "Open",
			'func', function (self, ...)
				PDAMERCBrowser.Open(self,...)
				AddPageToBrowserHistory("merc", nil)
			end,
		}),
		PlaceObj('XTemplateFunc', {
			'name', "Done(self, ...)",
			'func', function (self, ...)
				PDAMERCBrowser.Done(self,...)
			end,
		}),
		PlaceObj('XTemplateWindow', {
		...
		PlaceObj('XTemplateWindow', {
			'comment', "bkg frame JA2-MERC teal",
			'__class', "XImage",
			'Margins', box(-50, -1, -50, 0),
			'Dock', "box",
			'Image', "Mod/e6L4ECj/Icons/PDA/MERC_PdaBackdrop.png",
			'ImageFit', "stretch",
			'ImageColor', RGBA(150, 235, 225, 255),
		}),
		PlaceObj('XTemplateWindow', {
			...
			PlaceObj('XTemplateWindow', {
				...
				PlaceObj('XTemplateWindow', {
					'comment', "filters",
					'ScaleModifier', point(900, 1000),
					'__context', function (parent, context) return GetMERCScreenFilters() end,
					'Id', "idFilters",
					'MinHeight', 44,
					'MaxHeight', 44,
					'LayoutMethod', "HList",
					...
					PlaceObj('XTemplateWindow', {
						'comment', "bg merc teal",
						'__class', "XFrame",
						'Dock', "box",
						'Image', "UI/PDA/os_header",
						'FrameBox', box(3, 5, 3, 5),
						'Background', RGBA(0, 145, 155, 255),
					}),
					PlaceObj('XTemplateForEach', {
						'__context', function (parent, context, item, i, n) return item end,
						'run_after', function (child, context, item, i, n, last)
							child:SetGridX(i)
							local icon = "UI/Icons/hf_" .. (item.nameString == "hired" and "hired" or "all")
							child:SetIcon(icon)
						...
						PlaceObj('XTemplateWindow', {
							...
							'Translate', true,
							'Text', T(440475746284, --[[XTemplate PDAMERCBrowser Text]] "<name>"),
					...
					PlaceObj('XTemplateWindow', {
						...
						'Translate', true,
						'Text', T(712245129915, --[[XTemplate PDAMERCBrowser Text]] "<LB> <RB> - Change category"),
					}),
					}),
				PlaceObj('XTemplateWindow', {
					'comment', "MERC mark",
					...
					'MinHeight', 64,
					'MaxHeight', 72,
					'Image', "Mod/e6L4ECj/Icons/PDA/MERC_Mark.png",
					'ImageFit', "height",
				}),
				}),
			PlaceObj('XTemplateWindow', {
				...
				PlaceObj('XTemplateWindow', {
					...
					'Background', RGBA(15, 125, 135, 255),
				}),
				PlaceObj('XTemplateWindow', {
					...
					PlaceObj('XTemplateWindow', {
						...
						PlaceObj('XTemplateWindow', nil, {
							PlaceObj('XTemplateWindow', {
								...
								'FrameBox', box(3, 3, 3, 3),
								'Background', RGBA(10, 115, 125, 255),
							}),
							PlaceObj('XTemplateWindow', {
								...
								PlaceObj('XTemplateWindow', {
									...
									'MinHeight', 46,
									'MaxHeight', 46,
									'Image', "Mod/e6L4ECj/Icons/PDA/MERC_BannerPad.png",
									'ImageFit', "stretch",
								}),
								PlaceObj('XTemplateWindow', {
									'Margins', box(0, 5, 0, 0),
					...
					PlaceObj('XTemplateWindow', {
						...
						PlaceObj('XTemplateWindow', {
							...
							PlaceObj('XTemplateWindow', {
								...
								'Translate', true,
								'Text', T(890000000009902, --[[XTemplate PDAMERCBrowser Text]] "<style AimCopyrightTextC><copyright></style> M.E.R.C."),
							}),
							PlaceObj('XTemplateTemplate', {
								...
								'Text', T(891740393419, --[[XTemplate PDAMERCBrowser Text]] "About Us"),
							...
							PlaceObj('XTemplateTemplate', {
								...
								'TextStyle', "WebLinkButton_Hiring",
								'Text', T(111807730937, --[[XTemplate PDAMERCBrowser Text]] "Terms of Service"),
								'ActiveTextStyle', "WebLinkButton_Hiring_Heavy",
							}),
							}),
						}),
					...
					PlaceObj('XTemplateWindow', {
						...
						PlaceObj('XTemplateFunc', {
							...
							'func', function (self)
								...
								local departureTextFn = rawget(_G, "JAZZ_MERC_GetDepartureReasonText")
								...
								self.idMERCOrg:SetText(JAZZ_MERC_GetOrgLabel(context))
								self.idMERCStatus:SetText(JAZZ_MERC_GetStatusLabel(context))
							end,
						}),
						PlaceObj('XTemplateWindow', {
							'__class', "XFrame",
								...
								PlaceObj('XTemplateWindow', nil, {
									PlaceObj('XTemplateWindow', {
										...
										PlaceObj('XTemplateWindow', {
											...
											'Translate', true,
											'Text', T(351463573859, --[[XTemplate PDAMERCBrowser Text]] "<MercLevel()>"),
										}),
										PlaceObj('XTemplateWindow', {
											'__class', "XText",
											'HAlign', "center",
											...
											'Translate', true,
											'Text', T(141041371501, --[[XTemplate PDAMERCBrowser Text]] "Level"),
										}),
										}),
									PlaceObj('XTemplateWindow', {
										...
										PlaceObj('XTemplateWindow', {
											...
											'MaxHeight', 40,
											'ImageFit', "stretch",
											'ImageColor', RGBA(40, 170, 175, 255),
										}),
										PlaceObj('XTemplateWindow', {
											'__class', "XContextWindow",
											...
											PlaceObj('XTemplateWindow', {
												...
												'TextStyle', "MercName",
												'Translate', true,
												'Text', T(672662514512, --[[XTemplate PDAMERCBrowser Text]] "<Name> <MercFlagImage()>"),
												'TextVAlign', "bottom",
												'ImageScale', 1000,
												'SafeSpace', 70,
											}),
											...
											PlaceObj('XTemplateWindow', {
												...
												PlaceObj('XTemplateWindow', {
													...
													'TextStyle', "MercSubTitle",
													'Translate', true,
													'Text', T(890000000009900, --[[XTemplate PDAMERCBrowser Text]] "Org:"),
												}),
												PlaceObj('XTemplateWindow', {
													'__class', "XText",
													'Id', "idMERCOrg",
												...
												PlaceObj('XTemplateWindow', {
													...
													'TextStyle', "MercSubTitle",
													'Translate', true,
													'Text', T(890000000009901, --[[XTemplate PDAMERCBrowser Text]] "Status:"),
												}),
												PlaceObj('XTemplateWindow', {
													'__class', "XText",
													'Id', "idMERCStatus",
								...
								PlaceObj('XTemplateWindow', {
									...
									PlaceObj('XTemplateForEach', {
										...
										PlaceObj('XTemplateWindow', {
											...
											'RolloverText', T(157340803747, --[[XTemplate PDAMERCBrowser RolloverText]] "<help>"),
											'RolloverOffset', box(0, 0, 0, 5),
											'RolloverTitle', T(976520897583, --[[XTemplate PDAMERCBrowser RolloverTitle]] "<name>"),
											'IdNode', true,
										}, {
											PlaceObj('XTemplateWindow', {
							...
							PlaceObj('XTemplateWindow', {
								...
								PlaceObj('XTemplateWindow', {
									...
									PlaceObj('XTemplateWindow', {
										...
										'Translate', true,
										'Text', T(890000000000305, --[[XTemplate PDAMERCBrowser Text]] " "),
									}),
									PlaceObj('XTemplateWindow', {
										'__class', "XFrame",
										'Id', "idLineSep",
								...
								PlaceObj('XTemplateWindow', {
									...
									PlaceObj('XTemplateWindow', {
										...
										'RolloverTemplate', "RolloverGeneric",
										'RolloverAnchor', "center-top",
										'RolloverText', T(882683505602, --[[XTemplate PDAMERCBrowser RolloverText]] "<MercPriceBioPageRollover()>"),
										'RolloverOffset', box(0, 0, 60, 10),
										'RolloverTitle', T(457158173170, --[[XTemplate PDAMERCBrowser RolloverTitle]] "Weekly Cost"),
										'Id', "idValue",
										'HAlign', "right",
										'VAlign', "center",
										'TextStyle', "PDAMercPrice",
										'Translate', true,
										'Text', T(196392143876, --[[XTemplate PDAMERCBrowser Text]] "<MercPriceBioPage(7, true)>"),
										'TextVAlign', "center",
									}),
									}),
								}),
						...
						PlaceObj('XTemplateWindow', {
							...
							PlaceObj('XTemplateWindow', {
								...
								PlaceObj('XTemplateWindow', {
									...
									'TextStyle', "Hiring_Bio_Header",
									'Translate', true,
									'Text', T(984976462387, --[[XTemplate PDAMERCBrowser Text]] "Perks"),
									'TextVAlign', "center",
								}),
								PlaceObj('XTemplateWindow', {
									'comment', "perks (AIM-parity Traits/StartingPerks strip)",
									'LayoutMethod', "HWrap",
									'LayoutHSpacing', 10,
									'LayoutVSpacing', 10,
								}, {
								...
								PlaceObj('XTemplateWindow', {
									...
									PlaceObj('XTemplateWindow', {
										...
										'TextStyle', "Hiring_Bio_Header",
										'Translate', true,
										'Text', T(550507290667, --[[XTemplate PDAMERCBrowser Text]] "Equipment"),
										'TextVAlign', "center",
									}),
									PlaceObj('XTemplateWindow', {
										'LayoutMethod', "HWrap",
										...
										PlaceObj('XTemplateWindow', {
											...
											'LayoutMethod', "HList",
											'FoldWhenHidden', true,
											'BorderColor', RGBA(20, 70, 80, 255),
											'Background', RGBA(10, 45, 55, 150),
											'slot', "Head",
											'HideWhenEmpty', true,
										}),
										PlaceObj('XTemplateWindow', {
								...
								PlaceObj('XTemplateWindow', {
									...
									PlaceObj('XTemplateWindow', {
										...
										'TextStyle', "Hiring_Bio_Header",
										'Translate', true,
										'Text', T(801008989746, --[[XTemplate PDAMERCBrowser Text]] "Backpack"),
										'TextVAlign', "center",
									}),
									PlaceObj('XTemplateWindow', {
										'__class', "XInventoryItemEmbed",
						...
						PlaceObj('XTemplateWindow', {
							...
							PlaceObj('XTemplateWindow', nil, {
								PlaceObj('XTemplateWindow', {
									...
									'TextStyle', "Hiring_Bio_Header",
									'Translate', true,
									'Text', T(642133584014, --[[XTemplate PDAMERCBrowser Text]] "BIO - <Title>"),
								}),
								PlaceObj('XTemplateWindow', {
									'__class', "XScrollArea",
									'Id', "idBioContent",
		...
		PlaceObj('XTemplateWindow', nil, {
			...
			PlaceObj('XTemplateAction', {
				...
				'RolloverOffset', box(0, 0, 0, 8),
				'ActionId', "idDismiss",
				'ActionName', T(163956682203, --[[XTemplate PDAMERCBrowser ActionName]] "Dismiss"),
				'ActionToolbar', "ActionBar",
				'ActionButtonTemplate', "PDACommonButtonBlueSnype",
				'ActionState', function (self, host)
					local content = host.idContent
			...
			PlaceObj('XTemplateAction', {
				'ActionId', "idSeeBio",
				'ActionName', T(529989041592, --[[XTemplate PDAMERCBrowser ActionName]] "See Bio"),
				'ActionToolbar', "ActionBar",
				'ActionShortcut', "S",
				'ActionState', function (self, host)
					local content = host.idContent
			...
			PlaceObj('XTemplateAction', {
				'ActionId', "idHideBio",
				'ActionName', T(872907861571, --[[XTemplate PDAMERCBrowser ActionName]] "Loadout"),
				'ActionToolbar', "ActionBar",
				'ActionShortcut', "S",
				'ActionState', function (self, host)
					local content = host.idContent
			...
			PlaceObj('XTemplateAction', {
				...
				'OnAction', function (self, host, source, ...)
					...
					if not IsKindOf(content, "PDABrowser") then return end
					content = content.idBrowserContent
					if not IsKindOf(content, "PDAMERCBrowser") or not content.idMercData then return end
