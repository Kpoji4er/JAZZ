	...
	PlaceObj('XTemplateWindow', {
				...
				PlaceObj('XTemplateWindow', {
					...
					PlaceObj('XTemplateForEach', {
						...
						'run_after', function (child, context, item, i, n, last)
							child:SetGridX(i)
							child:SetIcon("Mod/e6L4ECj/MercIcons/hf_" .. item.nameString)
						...
						PlaceObj('XTemplateWindow', {
							...
							'Translate', true,
							'Text', T(440475746284, --[[XTemplate PDAAIMBrowser Text]] "<name>"),
					...
					PlaceObj('XTemplateWindow', {
						...
						'Translate', true,
						'Text', T(712245129915, --[[XTemplate PDAAIMBrowser Text]] "<LB> <RB> - Change category"),
					}),
					}),
				PlaceObj('XTemplateWindow', {
					'__class', "XImage",
							...
							PlaceObj('XTemplateWindow', {
								...
								PlaceObj('XTemplateWindow', {
									...
									PlaceObj('XTemplateWindow', {
										...
										'Translate', true,
										'Text', T(266087238479, --[[XTemplate PDAAIMBrowser Text]] "Bank Account"),
									}),
									PlaceObj('XTemplateWindow', {
					...
					PlaceObj('XTemplateWindow', {
						...
						PlaceObj('XTemplateWindow', {
							...
							PlaceObj('XTemplateWindow', {
								...
								'Translate', true,
								'Text', T(491974676910, --[[XTemplate PDAAIMBrowser Text]] "<style AimCopyrightTextC><copyright></style> AIM 2001"),
							}),
							PlaceObj('XTemplateTemplate', {
								...
								'Text', T(891740393419, --[[XTemplate PDAAIMBrowser Text]] "About Us"),
							...
							PlaceObj('XTemplateTemplate', {
								...
								'TextStyle', "WebLinkButton_Hiring",
								'Text', T(111807730937, --[[XTemplate PDAAIMBrowser Text]] "Terms of Service"),
								'ActiveTextStyle', "WebLinkButton_Hiring_Heavy",
							}),
							}),
						}),
								...
								PlaceObj('XTemplateWindow', nil, {
									PlaceObj('XTemplateWindow', {
										...
										PlaceObj('XTemplateWindow', {
											...
											'Translate', true,
											'Text', T(351463573859, --[[XTemplate PDAAIMBrowser Text]] "<MercLevel()>"),
										}),
										PlaceObj('XTemplateWindow', {
											'__class', "XText",
											'HAlign', "center",
											...
											'Translate', true,
											'Text', T(141041371501, --[[XTemplate PDAAIMBrowser Text]] "Level"),
										}),
										}),
									PlaceObj('XTemplateWindow', {
										...
										PlaceObj('XTemplateWindow', {
											...
											PlaceObj('XTemplateWindow', {
												...
												'TextStyle', "MercName",
												'Translate', true,
												'Text', T(672662514512, --[[XTemplate PDAAIMBrowser Text]] "<Name> <MercFlagImage()>"),
												'TextVAlign', "bottom",
												'ImageScale', 1000,
												'SafeSpace', 70,
											}),
								...
								PlaceObj('XTemplateWindow', {
									...
									PlaceObj('XTemplateForEach', {
										...
										PlaceObj('XTemplateWindow', {
											...
											'RolloverText', T(157340803747, --[[XTemplate PDAAIMBrowser RolloverText]] "<help>"),
											'RolloverOffset', box(0, 0, 0, 5),
											'RolloverTitle', T(976520897583, --[[XTemplate PDAAIMBrowser RolloverTitle]] "<name>"),
											'IdNode', true,
										}, {
											PlaceObj('XTemplateWindow', {
							...
							PlaceObj('XTemplateWindow', {
								...
								PlaceObj('XTemplateWindow', {
									...
									PlaceObj('XTemplateWindow', {
										...
										'RolloverTemplate', "RolloverGeneric",
										'RolloverAnchor', "center-top",
										'RolloverText', T(882683505602, --[[XTemplate PDAAIMBrowser RolloverText]] "<MercPriceBioPageRollover()>"),
										'RolloverOffset', box(0, 0, 60, 10),
										'RolloverTitle', T(457158173170, --[[XTemplate PDAAIMBrowser RolloverTitle]] "Weekly Cost"),
										'Id', "idValue",
										'HAlign', "right",
										'VAlign', "center",
										'TextStyle', "PDAMercPrice",
										'Translate', true,
										'Text', T(196392143876, --[[XTemplate PDAAIMBrowser Text]] "<MercPriceBioPage(7, true)>"),
										'TextVAlign', "center",
									}),
									}),
								}),
						...
						PlaceObj('XTemplateWindow', {
							...
							PlaceObj('XTemplateWindow', {
								...
								PlaceObj('XTemplateWindow', {
									...
									'TextStyle', "Hiring_Bio_Header",
									'Translate', true,
									'Text', T(984976462387, --[[XTemplate PDAAIMBrowser Text]] "Perks"),
									'TextVAlign', "center",
								}),
								PlaceObj('XTemplateWindow', {
									'comment', "perks",
								...
								PlaceObj('XTemplateWindow', {
									...
									PlaceObj('XTemplateWindow', {
										...
										'TextStyle', "Hiring_Bio_Header",
										'Translate', true,
										'Text', T(550507290667, --[[XTemplate PDAAIMBrowser Text]] "Equipment"),
										'TextVAlign', "center",
									}),
									PlaceObj('XTemplateWindow', {
										'LayoutMethod', "HWrap",
								...
								PlaceObj('XTemplateWindow', {
									...
									PlaceObj('XTemplateWindow', {
										...
										'TextStyle', "Hiring_Bio_Header",
										'Translate', true,
										'Text', T(801008989746, --[[XTemplate PDAAIMBrowser Text]] "Backpack"),
										'TextVAlign', "center",
									}),
									PlaceObj('XTemplateWindow', {
										'__class', "XInventoryItemEmbed",
						...
						PlaceObj('XTemplateWindow', {
							...
							PlaceObj('XTemplateWindow', nil, {
								PlaceObj('XTemplateWindow', {
									...
									'TextStyle', "Hiring_Bio_Header",
									'Translate', true,
									'Text', T(642133584014, --[[XTemplate PDAAIMBrowser Text]] "BIO - <Title>"),
								}),
								PlaceObj('XTemplateWindow', {
									'__class', "XScrollArea",
									'Id', "idBioContent",
		...
		PlaceObj('XTemplateWindow', nil, {
			...
			PlaceObj('XTemplateAction', {
				...
				'RolloverOffset', box(0, 0, 0, 8),
				'ActionId', "idDismiss",
				'ActionName', T(163956682203, --[[XTemplate PDAAIMBrowser ActionName]] "Dismiss"),
				'ActionToolbar', "ActionBar",
				'ActionButtonTemplate', "PDACommonButtonBlueSnype",
				'ActionState', function (self, host)
					local content = host.idContent
			...
			PlaceObj('XTemplateAction', {
				'ActionId', "idSeeBio",
				'ActionName', T(529989041592, --[[XTemplate PDAAIMBrowser ActionName]] "See Bio"),
				'ActionToolbar', "ActionBar",
				'ActionShortcut', "S",
				'ActionState', function (self, host)
					local content = host.idContent
			...
			PlaceObj('XTemplateAction', {
				'ActionId', "idHideBio",
				'ActionName', T(872907861571, --[[XTemplate PDAAIMBrowser ActionName]] "Loadout"),
				'ActionToolbar', "ActionBar",
				'ActionShortcut', "S",
				'ActionState', function (self, host)
					local content = host.idContent
