...
DefineClass.Region = {
    ...
    properties = {
      ...
      { category = "Legion AI/Economy", id = "CitySupplyBonus", name = "City money per hour ($)", editor = "number", default = 50, min = 0 },
      { category = "Legion AI/Economy", id = "FarmSupplyBonus", name = "Farm money per hour ($)", editor = "number", default = 10, min = 0 },
      ...
      { category = "Legion AI/Economy", id = "TaxCap", name = "Tax collector cap", editor = "number", default = 2, min = 0 },
      ...
      { category = "Legion AI/Manpower", id = "ManpowerCapacity", name = "Outpost manpower capacity", editor = "number", default = 60, min = 1 },
      ...
      { category = "Legion AI/Manpower", id = "FarmRecruitsPerDay", name = "Farm recruits per day", editor = "number", default = 1, min = 0 },
      { category = "Legion AI/Manpower", id = "CityRecruitsPerDay", name = "City recruits per day", editor = "number", default = 2, min = 0 },
      { category = "Legion AI/Manpower", id = "FarmRecruitCap", name = "Farm recruit stock cap", editor = "number", default = 8, min = 0 },
      { category = "Legion AI/Manpower", id = "CityRecruitCap", name = "City recruit stock cap", editor = "number", default = 20, min = 0 },
      { category = "Legion AI/Manpower", id = "RecruiterThreshold", name = "Recruiter threshold (people)", editor = "number", default = 8, min = 1 },
      { category = "Legion AI/Manpower", id = "RecruiterCap", name = "Recruiter cap", editor = "number", default = 2, min = 0 },
      ...
      { category = "Legion AI/Manpower", id = "ManpowerConvoyTriggerPercent", name = "Manpower convoy trigger (%)", editor = "number", default = 40, min = 0, max = 100 },
