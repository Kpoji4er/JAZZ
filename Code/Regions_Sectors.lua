...
DefineClass.Region = {
    ...
    properties = {
      ...
      { category = "Legion AI/Economy", id = "StartingSupply", name = "Starting money ($)", editor = "number", default = 12000, min = 0, help = "Runtime × JAZZ_LegionEconomyScalePct (STRATEGY-016 ÷4)." },
      { category = "Legion AI/Economy", id = "SupplyCapacity", name = "Outpost money capacity ($)", editor = "number", default = 120000, min = 1 },
      { category = "Legion AI/Economy", id = "PassiveSupplyPerHour", name = "Base money per hour ($)", editor = "number", default = 0, min = 0, help = "Runtime × economy scale (STRATEGY-016)." },
      { category = "Legion AI/Economy", id = "CitySupplyBonus", name = "City money per POI pulse ($)", editor = "number", default = 2500, min = 0, help = "Added to poi_money every POIGenerationInterval. Runtime × economy scale." },
      { category = "Legion AI/Economy", id = "FarmSupplyBonus", name = "Farm money per POI pulse ($)", editor = "number", default = 800, min = 0, help = "Added to poi_money every POIGenerationInterval. Runtime × economy scale." },
      { category = "Legion AI/Economy", id = "PoiMoneyCap", name = "POI money stock cap ($)", editor = "number", default = 12000, min = 1, help = "Max tax stock on one POI. Runtime × economy scale." },
      { category = "Legion AI/Economy", id = "POIGenerationInterval", name = "POI resource pulse (hours)", editor = "number", default = 96 * const.Scale.h, scale = const.Scale.h, min = const.Scale.h, max = 336 * const.Scale.h, help = "How often city/farm $ and recruits accrue on economic POIs (STRATEGY-016: 96h)." },
      ...
      { category = "Legion AI/Economy", id = "MineDiamondPerHour", name = "Mine money per hour to shipment stock ($)", editor = "number", default = 250, min = 0, help = "Runtime × economy scale (STRATEGY-016 ÷4 diamond income)." },
      ...
      { category = "Legion AI/Economy", id = "SupplyConvoyCargo", name = "Supply convoy cargo ($)", editor = "number", default = 12000, min = 1, help = "Runtime × economy scale." },
      { category = "Legion AI/Economy", id = "DiamondShipmentThreshold", name = "Shipment threshold ($)", editor = "number", default = 12000, min = 1, help = "Runtime × economy scale so cadence matches slower mine fill." },
      ...
      { category = "Legion AI/Economy", id = "TaxCargoMax", name = "Tax collector cargo max ($)", editor = "number", default = 12000, min = 1, help = "Runtime × economy scale." },
      { category = "Legion AI/Economy", id = "TaxCooldown", name = "Tax collector cooldown (hours)", editor = "number", default = 48 * const.Scale.h, scale = const.Scale.h, min = 0, max = 168 * const.Scale.h },
      { category = "Legion AI/Manpower", id = "StartingManpower", name = "Outpost starting manpower", editor = "number", default = 20, min = 0, help = "Runtime × economy scale; floor 8." },
      { category = "Legion AI/Manpower", id = "ManpowerCapacity", name = "Outpost manpower capacity", editor = "number", default = 32, min = 1 },
      { category = "Legion AI/Manpower", id = "MajorStartingManpower", name = "Major starting manpower", editor = "number", default = 80, min = 0, help = "Runtime × economy scale; floor 16." },
      { category = "Legion AI/Manpower", id = "MajorManpowerCapacity", name = "Major manpower capacity", editor = "number", default = 600, min = 1 },
      { category = "Legion AI/Manpower", id = "FarmRecruitsPerDay", name = "Farm recruits per POI pulse", editor = "number", default = 2, min = 0, help = "Runtime × economy scale." },
      { category = "Legion AI/Manpower", id = "CityRecruitsPerDay", name = "City recruits per POI pulse", editor = "number", default = 3, min = 0, help = "Runtime × economy scale." },
      ...
      { category = "Legion AI/Manpower", id = "RecruiterCooldown", name = "Recruiter cooldown (hours)", editor = "number", default = 48 * const.Scale.h, scale = const.Scale.h, min = 0, max = 168 * const.Scale.h },
      ...
      { category = "Legion AI/Economy", id = "MajorStartingReserve", name = "Major starting money ($)", editor = "number", default = 120000, min = 0, help = "Runtime × economy scale." },
      ...
      { category = "Legion AI/Caps", id = "SupportCap", name = "Support cap", editor = "number", default = 1, min = 0, help = "Small specialist detachments (sniper/MG/mortar). Separate from ReinforceCap." },
      ...
      { category = "Legion AI/Costs", id = "SupportCost", name = "Support cost ($)", editor = "number", default = 18000, min = 0, help = "Fallback flat cost; combat spawn charges unit-price sum." },
      ...
      { category = "Legion AI/Missions", id = "SupportMissions", name = "Support missions", editor = "number", default = 2, min = 1 },
  ...
  function Region:GetRolloverHint(sector_id)
    ...
    if self.Description and self.Description ~= "" then
        ...
        hint[#hint+1] = T{227814808041, "<Description>", Description = description}
    end
