...
DefineClass.Region = {
    ...
    properties = {
      ...
      { category = "Legion AI/Economy", id = "StartingSupply", name = "Starting supply", editor = "number", default = 50, min = 0 },
      ...
      { category = "Legion AI/Economy", id = "SupplyConvoyCargo", name = "Supply convoy cargo", editor = "number", default = 150, min = 1 },
      ...
      { category = "Legion AI/Economy", id = "MajorReserveCapacity", name = "Major reserve capacity", editor = "number", default = 5000, min = 1 },
      ...
      { category = "Legion AI/Costs", id = "GarrisonCost", name = "Garrison cost", editor = "number", default = 180, min = 0 },
      { category = "Legion AI/Costs", id = "PatrolCost", name = "Patrol cost", editor = "number", default = 90, min = 0 },
      { category = "Legion AI/Costs", id = "ReconCost", name = "Recon cost", editor = "number", default = 50, min = 0 },
      { category = "Legion AI/Costs", id = "QRFCost", name = "QRF cost", editor = "number", default = 140, min = 0 },
      ...
      { category = "Legion AI/Major", id = "MajorResponseCost", name = "Major response cost", editor = "number", default = 300, min = 0 },
