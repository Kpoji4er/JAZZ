PlaceObj('CombatAction', {
	...
	DisplayName = T(526647186745, --[[CombatAction Merc_MildredPatterson_Bookworm DisplayName]] "<placeholder>"),
	...
	Icon = "Mod/e6L4ECj/Images/WorkshopMercs/Mildred_Perk_Passive.png",
